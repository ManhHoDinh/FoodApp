...
class _HomeScreenState extends State<HomeScreen>
  ...
  void CreateFoods() {
    ...
    foodDetail f1 = foodDetail(
        ...
        primaryImage: ImageAssests.item1,
        subImage: subImage);
    Foods.add(f1);
    foodDetail f2 = foodDetail(
        ...
        primaryImage: ImageAssests.item2,
        subImage: subImage);
    ...
    foodDetail f3 = foodDetail(
        ...
        primaryImage: ImageAssests.item3,
        subImage: subImage);
    Foods.add(f3);
    foodDetail f4 = foodDetail(
        ...
        primaryImage: ImageAssests.item4,
        subImage: subImage);
    Foods.add(f4);
    foodDetail f5 = foodDetail(
        ...
        returnPolicy:
            'Veggie tomato mix: All our foods are double checked before leaving our stores so by any case you found a broken food please contact our hotline immediately.',
        primaryImage: ImageAssests.item5,
        subImage: subImage);
    Foods.add(f5);
    foodDetail f6 = foodDetail(
        ...
        returnPolicy:
            'Veggie tomato mix: All our foods are double checked before leaving our stores so by any case you found a broken food please contact our hotline immediately.',
        primaryImage: ImageAssests.item6,
        subImage: subImage);
    Foods.add(f1);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      drawer: Drawer(
        backgroundColor: ColorPalette.highlightColor,
      ),
      body: Column(
        children: [
          Container(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => SearchScreen(foods: Foods)));
                },
                child: Row(
                  children: [
                    Icon(
            ...
            children: [
              ...
              Positioned(
                  child: Container(
                      ...
                      child: Image.asset(
                            widget.Foods[index]!.PrimaryImage ?? '',
                            width: 183,
                            height: 276,
                          ) ??
                          Container()))
